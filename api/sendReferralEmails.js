...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Query Firestore for focal persons in the receiving organization
        ...
        // Include the referrer in the recipient list
        const recipients = [...focalEmails, referralData.createdByEmail];
...
`
        ...
        return res.status(200).json({ success: true, message: "Emails sent to focal persons and referrer" });
