...
const ReferredByMe = () => {
    ...
    const fetchReferrals = async () => {
      ...
      try {
        ...
        const q = query(
          ...
          where("createdByOrg", "==", currentUserOrg),
  ...
  return (
    <div className="mx-auto relative overflow-x-auto shadow-md sm:rounded-lg p-4">
      <h2 className="text-2xl font-bold mb-4">Referrals By My Org [{currentUserOrg}]</h2>
          ...
          {loading ? (
            ...
            currentItems.map((r) => (
              <tr key={r.id}>
                ...
                <td className="border px-4 py-2">{r.referralTo}</td>
